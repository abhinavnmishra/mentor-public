...
const GradientCard = styled(Card)(({ theme }) => ({
    borderRadius: '16px',
    border: `1px solid ${colors.border}`,
    background: `linear-gradient(135deg, ${alpha(colors.primary, 0.05)} 0%, ${alpha(colors.success, 0.05)} 100%)`,
    boxShadow: '0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px 0 rgba(0, 0, 0, 0.06)',
    transition: 'all 0.2s ease-in-out',
    '&:hover': {
        boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)',
        ...
        <Box sx={{ 
            ...
            <Box sx={{ 
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                    <Box sx={{ 
                        ...
                        <Poll sx={{ color: colors.success, fontSize: '24px' }} />
                    </Box>
                    <Box>
                        <Typography 
                            variant="h5" 
                        ...
                        >
                            View survey details and manage responses
                        </Typography>
                    </Box>
                </Box>
            </Box>
            ...
            <GradientCard>
                ...
                <CardActions sx={{ padding: '24px', paddingTop: '0' }}>
                    <Tooltip title="Open survey in new tab to view and manage">
                        <ActionButton 
