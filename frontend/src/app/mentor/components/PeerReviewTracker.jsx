...
const PeerReviewTracker = ({milestone}) => {
    ...
    const handleAutoAwesomeNotes = async () => {
        if (!trackerId) {
            showAlert('Please save the peer review first', 'error');
            return;
        }
        ...
        try {
            const response = await axiosInstance.post('/api/ai/completion', {
                keyword: 'trainer_notes_client_peer_review',
                id: trackerId,
                ...
                <Grid size={{ xs: 12, md: 6 }}>
                    <SectionHeader>
                        <Box sx={{ 
                            ...
                            <People sx={{ color: colors.primary, fontSize: '18px' }} />
                        </Box>
                        <Typography 
                            sx={{ 
                                fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
                    ...
                    <ModernCard>
                        <CardContent sx={{ padding: '24px' }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                                <Box sx={{ 
                                    ...
                                    <Star sx={{ color: colors.primary, fontSize: '20px' }} />
                                </Box>
                                <Box sx={{ flex: 1 }}>
                                    <Typography 
                                        variant="h6" 
                            ...
                            <Stack spacing={2}>
                                ...
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    <People sx={{ color: colors.text.secondary, fontSize: '16px' }} />
                                    <Typography 
                                        sx={{ 
                                            fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
                                            fontSize: '0.875rem',
                                    ...
                                    >
                                        <strong>Reviewers:</strong> 3 peers
                                    </Typography>
                                </Box>

                                <Box sx={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    <Star sx={{ color: colors.warning, fontSize: '16px' }} />
                                    <Typography 
                                        sx={{ 
                                            fontFamily: '"Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
                                            fontSize: '0.875rem',
                                    ...
                                    >
                                        <strong>Average Rating:</strong> 4.2/5.0
                                    </Typography>
                                </Box>
                            </Stack>
                        </CardContent>
                        ...
                        <CardActions sx={{ padding: '16px 24px 24px 24px', gap: '12px' }}>
                            <ModernButton 
                                // onClick={() => { window.open('/peer-review/' + milestone.peerReviewResponseList[0].id, '_blank');}}
                                variant="contained" 
                                startIcon={<Launch />}
                                sx={{
                        ...
                        <Box sx={{ position: 'relative', width: '100%', border: `1px solid ${colors.border}`, borderRadius: '12px', overflow: 'hidden' }}>
                            ...
                            <Editor
                                ...
                                init={{
                                    ...
                                    statusbar: true,
                                    elementpath: false,
                                    placeholder: 'Enter your trainer comments and observations about the peer review...'
                                }}
                            />
                            {errors.trainerNotes && (
                                <Typography 
...
export default PeerReviewTracker;