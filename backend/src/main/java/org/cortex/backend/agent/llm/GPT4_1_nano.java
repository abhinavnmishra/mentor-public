...
@Service("GPT4_1_nano")
public class GPT4_1_nano extends AbstractLLM {
    ...
    private static final Logger logger = LoggerFactory.getLogger(GPT4_1_nano.class);
    private final String MODEL = "gpt-4.1-nano-2025-04-14";
